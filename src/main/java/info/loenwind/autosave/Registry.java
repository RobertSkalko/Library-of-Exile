...
public class Registry {
    ...
    static {
        ...
        GLOBAL_REGISTRY.register(new HandlePrimitive<CompoundNBT>(new CompoundNBT(), CompoundNBT.class, CompoundNBT.class, CompoundNBT::put, (compoundTag, key) -> (CompoundNBT) compoundTag.get(key)));
